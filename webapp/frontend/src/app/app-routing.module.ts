...
const routes: Routes = [
  {
    ...
    loadChildren: () =>
      import('./pages/discussion-list/discussion-list.module').then(
        (m) => m.DiscussionListPageModule
      ),
  ...
  },
  {
    ...
    loadChildren: () =>
      import('./pages/new-discussion/new-discussion.module').then(
        (m) => m.NewDiscussionPageModule
      ),
    canActivate: [LoggedInGuardGuard],
  },
  {
